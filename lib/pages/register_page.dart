            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Image.asset(
                    'assets/bhx_logo.png', // Đổi đường dẫn logo nếu cần
                    height: 100,
                  ),
                ),
                // Form Đăng Ký
                ...
                ElevatedButton(
                  onPressed: () async {
                    bool success = await AuthService().signUpWithEmailPassword(
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pop(context); // Quay lại trang trước (Login)
                  },
                  child: Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          // Tiêu đề và trường nhập Số điện thoại
          _buildFieldWithLabel(
            label: 'Số điện thoại',
            controller: phoneNumberController,
            icon: Icons.phone, // Icon điện thoại
            obscureText: false,
          ),
          SizedBox(height: 20),
